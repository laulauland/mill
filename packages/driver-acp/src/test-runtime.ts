...
export const runWithBunContext = <A, E>(effect: Effect.Effect<A, E, Scope.Scope>): Promise<A> =>
  Runtime.runPromise(runtime)(Effect.scoped(Effect.provide(effect, BunContext.layer)));
